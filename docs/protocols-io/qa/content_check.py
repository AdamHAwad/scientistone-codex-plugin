...
def main() -> int:
    ...
    checks = {
        ...
        "approved_run_requires_verified_paper": "Every completed, verified research run includes a paper" in text,
        "repairs_repeat_without_a_stopping_budget": "as many times as needed" in text,
        "does_not_teach_stopping_an_approved_run": "stop the run" not in text.lower(),
