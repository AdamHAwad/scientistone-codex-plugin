...
The software may produce incomplete, wrong, biased, irreproducible, or unsafe output. Review the saved evidence, code, evaluator, limits, and audit before relying on a result or publishing it.

OpenAI, hosts, publishers, registries, and research databases operate under their own terms. This project does not grant rights to outside data, papers, software, names, or marks.

To the extent allowed by law, the software comes without warranties and with the limits of liability in the Apache License 2.0.
