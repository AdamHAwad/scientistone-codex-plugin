...
test("task-adaptive variance cannot widen margins and all four aggregate verdicts are frozen", () => {
  ...
  assert.deepEqual(schema.properties.verdicts.properties.allowed.const, ["PASS", "FAIL", "INCONCLUSIVE", "NOT_ASSESSED"]);
  ...
  for (const verdict of ["`FAIL`", "`NOT_ASSESSED`", "`INCONCLUSIVE`", "`PASS`"]) {
