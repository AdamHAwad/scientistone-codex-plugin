...
import { executionId as computeI1ExecutionId } from "../../plugins/scientistone/skills/scientistone/scripts/i1-interpreter.mjs";
...
const INTERPRETER_SOURCE = fileURLToPath(new URL("../../plugins/scientistone/skills/scientistone/scripts/i1-interpreter.mjs", import.meta.url));
const ROLE_CONTRACT_SOURCE = fileURLToPath(new URL("../../plugins/scientistone/skills/scientistone/references/roles.md", import.meta.url));
