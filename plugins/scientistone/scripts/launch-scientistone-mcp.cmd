...
if "%~1"=="" (
  echo ScientistOne could not start its local interface: missing server path. 1>&2
  exit /b 64
)
...
echo ScientistOne could not find the Node.js runtime included with Codex. Reinstall or update Codex. 1>&2
exit /b 127
